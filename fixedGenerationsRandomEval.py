...
def evolveAgents():
    ...
    for generationIndex in range(0, 20):
        ...
        #repeat
        print("Beginning generation " + str(generationIndex) + " with baseline winrate " + str(bestWinRate))
        ...
        #test the best agent in 100 games against a random agent
        for x in range(100): # play x games
            ...
            blackWon = playGameRandom(colour, genBestAgent, 1, DEBUG)
        ...
        #save the data to be graphed, starting with the winrate
